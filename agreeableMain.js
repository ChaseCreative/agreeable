...
function get(x){
  ...
  //CHANGE THE NAMES OF THE GAMES HERE
    var game1Title = get("answerOne").innerHTML = "Be Agreeable!";
...
function appName() {get("boxTwo").innerHTML = "agreeable";}

function gameTitle() {get("startButton").innerHTML = "Make Me Agree!";}
...
function answerSetup(){
 ...
 function selectGame1(){
 	...
 	startButton.disabled = false;
 	startButton.onclick = function(){beAgreeable()};
